...
export const PRODUCTS = [
  ...
  {
    id: 'curso-teamor-aulas',
    slug: 'curso-teamor-aulas',
    category: 'cursos',
    title: 'TEAmor — Curso em Áudio',
    subtitle: 'Aulas práticas para famílias com filhos com TEA',
    description: 'Curso completo em áudio no Telegram, organizado por tópicos, para famílias que querem entender e agir com direção na saúde dos filhos. Aulas sobre hidratação, dieta, desparasitação, detox, quelação, regeneração intestinal e ativação neural — tudo em formato podcast, para ouvir no seu tempo.',
    ...
    hidden: true,
    features: [
      'Aulas em áudio (formato podcast) no Telegram',
      'Módulos sobre hidratação, dieta, desparasitação, detox',
      'Quelação de metais e regeneração intestinal',
      'Ativação neural e desinflamação',
      'Conteúdo organizado por tópicos',
      'Novos módulos liberados mensalmente',
    ],
    gradient: 'linear-gradient(135deg, #1a7ab5 0%, #4ecdc4 100%)',
  },
  {
    id: 'curso-teamor-interacao',
    slug: 'curso-teamor-interacao',
    category: 'cursos',
    title: 'TEAmor — Grupo de Acompanhamento',
    subtitle: 'Dúvidas, partilhas e suporte entre famílias',
    description: 'Grupo de interação no Telegram para tirar dúvidas, compartilhar experiências e receber apoio de outras famílias e da equipe. Organizado por tópicos para manter tudo claro e funcional. Ideal para quem quer acompanhamento na jornada.',
    image: '/images/logo-teamor.png',
    price: 4700, // R$ 47,00
    ...
    hidden: true,
    features: [
      'Grupo de dúvidas e partilhas no Telegram',
      'Apoio da equipe e de outras famílias',
      'Organizado por tópicos',
      'Ambiente acolhedor e funcional',
      'Troca de experiências reais',
      'Cancele quando quiser',
    ],
    gradient: 'linear-gradient(135deg, #4ecdc4 0%, #1a7ab5 100%)',
  },
